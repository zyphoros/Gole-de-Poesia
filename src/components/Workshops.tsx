...
export const Workshops: React.FC = () => {
  return (
    <section
      id="oficinas"
      className="relative bg-[#E8A324] text-[#4A1030] pt-10 pb-14 md:pt-14 md:pb-16 overflow-hidden"
    >
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="text-center max-w-3xl mx-auto mb-6 sm:mb-8">
          ...
          <div className="inline-flex items-center gap-2 bg-[#4A1030] text-[#F5EDE0] px-3 py-1 rounded-full font-display text-xs sm:text-sm tracking-widest uppercase mb-2.5 shadow-sm transform -rotate-1">
            <MapPin className="w-3.5 h-3.5 text-[#E8A324]" />
            <span>Formação Gratuita • Taguatinga - DF</span>
          </div>

          <h2 className="font-display text-3xl sm:text-4xl md:text-5xl text-[#4A1030] uppercase tracking-tight leading-none mb-2">
            4 OFICINAS. <span className="text-[#340720]">4 EXPERIÊNCIAS.</span>
          </h2>

          <p className="font-script text-xl sm:text-2xl text-[#340720] font-bold">
            Um gole de formação para quem vive de verso, cena e projeto.
          </p>

          <p className="font-body text-xs sm:text-sm text-[#4A1030]/85 max-w-2xl mx-auto mt-2 leading-relaxed">
          ...
          <div className="flex flex-wrap items-center justify-center gap-2 sm:gap-2.5 mt-3 text-xs font-semibold">
            <span className="flex items-center gap-1.5 bg-[#FAF4EA] text-[#4A1030] px-2.5 py-0.5 rounded-lg shadow-sm border border-[#4A1030]/15 text-[11px] sm:text-xs">
              <CheckCircle className="w-3 h-3 text-[#4A1030]" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3.5 sm:gap-4 lg:gap-4">
        ...
        <div className="mt-10 p-5 bg-[#FAF4EA]/85 backdrop-blur-sm rounded-2xl border-2 border-[#4A1030]/20 text-center max-w-2xl mx-auto shadow-md">
